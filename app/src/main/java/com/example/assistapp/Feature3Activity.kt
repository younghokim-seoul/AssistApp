...
class Feature3Activity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        speak("기능 3 화면입니다. 두 번 탭하면 실행합니다.")
    }
    ...
    private inner class GestureListener : GestureDetector.SimpleOnGestureListener() {
        ...
        override fun onDoubleTap(e: MotionEvent): Boolean {
            ...
            if (tapCount == 1) {
                ...
                startActivity(Intent(this@Feature3Activity, MainActivity::class.java))
                finish()
            }
            return true
        }
